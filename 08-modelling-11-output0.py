...
y_scaled = df_scaled_y.values[:, 0] # Assuming only one target variable
...
x_train_scaled, x_rem_scaled, y_train_scaled, y_rem_scaled = train_test_split(x_scaled, y_scaled, train_size=0.5, random_state=42)
